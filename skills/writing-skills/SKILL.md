...
**Personal skills live in your plugin's `skills/` directory. Copilot CLI discovers them via `plugin.json`.**
...
- Project-specific conventions (put in COPILOT.md or AGENTS.md)
...
**IMPORTANT: Create task tracking (checklist, SQLite, or markdown) for EACH checklist item below.**
