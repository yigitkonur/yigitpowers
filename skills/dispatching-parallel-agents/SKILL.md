...
```
# Using Copilot CLI subagent dispatch or /fleet
...
**Tip:** Copilot CLI's `/fleet` command can decompose and dispatch these automatically with dependency-aware scheduling.
